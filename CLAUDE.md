...
- `src/data/passives.json` — Passive definitions: triggered (Authority, Hope, Inner Fire, Momentum, Collapse, Vengeance, Reaper, Meditation) and permanent traits (Resourcefulness, Innocence, Thorns).
