...
- `app.js` — lightweight UI bootstrapping, currently tab switching plus replay loading, validation, metadata rendering, snapshot board rendering, replay state application, and playback controls
